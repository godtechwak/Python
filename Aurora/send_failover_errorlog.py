...
import math
import sys
sys.path.append('D:\Python\Toy_Project\Aurora_Failover_Error_Message\config')
import config
...
def get_db_instance_n_log_event(*befter_datetime):
        ...
        b_datetime=befter_datetime[0]
        a_datetime=befter_datetime[1]
        ...
        response=client_log.get_log_events(
            ...
            logStreamName=db_instance_writer_id,
            startTime=math.trunc(a_datetime.timestamp()),
            endTime=math.trunc(b_datetime.timestamp())
        )
